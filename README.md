...
This was a partnership project in which we learned about the details, advantages,
and disadvantages of using trees as data structures. We learned about how to
implement trees as well as how to traverse them. Throughout the project, we
...
* __Revelation Mudoti__ <[revelation-coder](https://github.com/revelation-coder)>
* __Herbert Kabagambe__ <[](https://github.com/)>
